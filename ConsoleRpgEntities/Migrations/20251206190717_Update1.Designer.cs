...
namespace ConsoleRpgEntities.Migrations
{
    ...
    [Migration("20251206190717_Update1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Abilities.PlayerAbilities.CombatAbility", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("CombatAbility");
                });
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Abilities.PlayerAbilities.FireballAbility", b =>
                {
                    ...
                    b.ToTable("Abilities", t =>
                        {
                            t.Property("Damage")
                                .HasColumnName("FireballAbility_Damage");
                        });
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Abilities.PlayerAbilities.HealAbility", b =>
                {
                    ...
                    b.ToTable("Abilities", t =>
                        {
                            t.Property("Damage")
                                .HasColumnName("HealAbility_Damage");
                        });
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Abilities.PlayerAbilities.ShoveAbility", b =>
                {
                    ...
                    b.ToTable("Abilities", t =>
                        {
                            t.Property("Damage")
                                .HasColumnName("ShoveAbility_Damage");

                            t.Property("Distance")
                                .HasColumnName("ShoveAbility_Distance");
                        });

                    b.HasDiscriminator().HasValue("ShoveAbility");
                });

            modelBuilder.Entity("ConsoleRpgEntities.Models.Characters.Monsters.Bandit", b =>
                {
                    b.HasBaseType("ConsoleRpgEntities.Models.Characters.Monsters.Monster");

                    b.HasDiscriminator().HasValue("Bandit");
                });

            modelBuilder.Entity("ConsoleRpgEntities.Models.Characters.Monsters.Beast", b =>
                {
                    b.HasBaseType("ConsoleRpgEntities.Models.Characters.Monsters.Monster");

                    b.HasDiscriminator().HasValue("Beast");
                });
            ...
            modelBuilder.Entity("ConsoleRpgEntities.Models.Characters.Monsters.Undead", b =>
                {
                    b.HasBaseType("ConsoleRpgEntities.Models.Characters.Monsters.Monster");

                    b.HasDiscriminator().HasValue("Undead");
                });
